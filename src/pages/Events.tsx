...
const Events = ({ onNavigate }: PageProps) => {
  const upcomingEvents = [
    {
      ...
      description:
        'Enjoy smooth jazz performances by local artists in an intimate setting.',
      image:
    ...
    },
    {
      ...
      description:
        'Test your knowledge in our weekly quiz night. Great prizes to be won!',
      image:
    ...
    },
    {
      ...
      description:
        'Ring in the new year with us! Live music, special menu, and champagne toast.',
      image:
    ...
    },
    {
      ...
      description:
        'Traditional British Sunday roast with all the trimmings.',
      image:
        'https://images.pexels.com/photos/8869807/pexels-photo-8869807.jpeg?auto=compress&cs=tinysrgb&w=800',
      price: 'From £14.99',
    },
    {
      ...
      time: '8:00 PM - 11:00 PM',
      description:
        'Showcase your talent or enjoy performances by aspiring artists.',
      image:
    ...
    },
    {
      ...
      description:
        'Sample a selection of premium craft beers with expert guidance.',
      image:
  ...
  return (
    <section id='events'><div className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 pt-24 pb-16">
